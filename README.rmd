...
```{r eval=FALSE}
dataSets <- PerformNormalization("endotoxin_data.txt", "none", 15, 4,"true","false");
```
...
```
Check the resulting png image (Gene_5111_dpi72.png) in your working directory. <br />
...
#### 2.2 Read and process individual dataset
```{r eval=FALSE}
